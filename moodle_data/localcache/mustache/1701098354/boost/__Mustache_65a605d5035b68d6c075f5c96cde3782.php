...
class __Mustache_65a605d5035b68d6c075f5c96cde3782 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section21188472d183068d3f3b15649ff4a759($context, $indent, $value);
        $value = $context->find('headerdisplaymultipage');
        if (empty($value)) {
            
            $value = $context->find('sitehome');
            $buffer .= $this->section516ea879d4c8d745cd8ce3d6c31e122a($context, $indent, $value);
            $value = $context->find('sitehome');
            if (empty($value)) {
...
';
    ...
    private function section21188472d183068d3f3b15649ff4a759(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section516ea879d4c8d745cd8ce3d6c31e122a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
